...
public class CaesarEncryption implements IStringEncryptionMethod {
    ...
    public MethodNode createDecrypt(String name) {
        MethodNode methodVisitor = new MethodNode(ACC_PRIVATE | ACC_STATIC, name, "(Ljava/lang/String;I)Ljava/lang/String;", null, null);
        ...
        methodVisitor.visitFrame(F_APPEND, 2, new Object[]{"java/lang/StringBuilder", INTEGER}, 0, null);
